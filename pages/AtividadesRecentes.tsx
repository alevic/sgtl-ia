            ...
            <div className="bg-white dark:bg-slate-800 p-4 rounded-sm shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col md:flex-row gap-4 justify-between">
                ...
                <div className="flex gap-2 overflow-x-auto pb-2 md:pb-0">
                    <button
                        ...
                        className={`px-4 py-2 rounded-sm text-sm font-medium transition-colors whitespace-nowrap ${filterType === 'all'
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-sm text-sm font-medium transition-colors whitespace-nowrap ${filterType === 'success'
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-sm text-sm font-medium transition-colors whitespace-nowrap ${filterType === 'warning'
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-sm text-sm font-medium transition-colors whitespace-nowrap ${filterType === 'info'
