    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex flex-col pb-10">
            ...
            <main className="flex-1 max-w-lg mx-auto w-full p-4 space-y-6">
                ...
                {/* Ticket/QR Card */}
                <div className={`bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden ${status === 'CANCELADA' ? 'opacity-60 grayscale' : ''}`}>
                    <div className="p-6 text-center border-b border-dashed border-slate-200 dark:border-slate-700 relative">
                        ...
                        {(status === 'PENDENTE' || status === 'PENDING') ? (
                            <div className="py-4 space-y-4">
                                <div className="w-24 h-24 mx-auto bg-slate-100 dark:bg-slate-900 rounded-2xl flex items-center justify-center text-slate-300">
                                    <QrCode size={48} />
                                </div>
                                <p className="text-sm text-slate-500 px-8">Pague para liberar seu QR Code de embarque.</p>
                                <button className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20 transition-all">
                                    <CreditCard size={20} />
                            ...
                            <div className="py-4 space-y-4">
                                <div className="p-4 bg-white rounded-2xl inline-block shadow-inner ring-1 ring-slate-100">
                ...
                <button className="w-full bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm flex items-center justify-between hover:bg-slate-50 transition-colors">
                ...
                {/* Help/Support */}
                <div className="flex items-center gap-2 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-2xl text-blue-800 dark:text-blue-300 border border-blue-100 dark:border-blue-900/50">
                    <Info size={20} />
            ...
            {showCancelModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 max-w-sm w-full relative shadow-2xl animate-in zoom-in-95 duration-200">
                        ...
                        <div className="bg-slate-50 dark:bg-slate-900/50 p-4 rounded-xl mb-6 space-y-2">
                        ...
                        <div className="space-y-3">
                            <button
                                ...
                                className="w-full bg-red-600 hover:bg-red-500 text-white font-bold py-3.5 rounded-xl transition-all shadow-lg shadow-red-500/20"
                            >
                                Sim, Cancelar e Gerar Crédito
                            </button>
                            <button
                                onClick={() => setShowCancelModal(false)}
                                className="w-full bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold py-3.5 rounded-xl transition-all"
                            >
                                Não, Voltar
                            </button>
                        </div>
