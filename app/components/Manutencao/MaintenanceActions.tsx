...
export const MaintenanceActions: React.FC<MaintenanceActionsProps> = ({ manutencao, onDelete, onUpdate }) => {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            if (onDelete) onDelete(manutencao.id);
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56 p-2 rounded-2xl shadow-2xl border-none bg-card/95 backdrop-blur-md">
                    ...
                    <DropdownMenuItem
                        onClick={() => navigate(`/admin/maintenance/${manutencao.id}/edit`)}
