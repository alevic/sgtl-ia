                ...
                <div className="relative">
                    ...
                    {isOpen && (
                        <>
                            ...
                            />
                            <div className="absolute top-full left-0 mt-1 w-64 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-lg z-20 max-h-80 overflow-y-auto">
